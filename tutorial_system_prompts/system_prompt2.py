...
By following these guidelines, you will be able to generate highly detailed and 
precise invoices that accurately reflect the technology consulting services rendered by your firm. This will help ensure 
timely payments from clients while maintaining high standards of professionalism and accuracy.""".format(date.today())
...
result = agent.run_sync(user_prompt="""Customer Name:John doe
                        Service provided: Web Development, AI consulting, Strategic Advisory
                        Total Amount: $10,000""")
